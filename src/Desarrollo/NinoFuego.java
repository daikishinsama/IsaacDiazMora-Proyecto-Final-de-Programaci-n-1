...
public class NinoFuego {
    ...
    AudioClip sonido4=java.applet.Applet.newAudioClip(getClass().getResource("../sonidos/wonderful.wav"));
     AudioClip sonido5=java.applet.Applet.newAudioClip(getClass().getResource("../sonidos/interruptor.wav"));
    Mapa mapa = new Mapa();
    
    public TableroJuego p;
    public static boolean interruptor=false;
    public static boolean interruptorC=false;
    public static boolean palanca=false;
...
public void KeyPressed(KeyEvent e){
    ...
    public void mover(){
        ...
        //Gravedad de salto
        if(map[(y/40)+1][x/40]==0  && choqueBarra1()==false &&  choqueBarra2()==false){
                y=y+movimiento; 
        }
        if(choqueBarra1()){
            y=Barra1.y1-40;
    ...
    public void Salto(KeyEvent e){
     ...
     public Area getBoundsFuego(){
      ...
      public boolean choqueInterruptor(){
        Area m1 = new Area(p.interruptor.getBoundsInterruptor());
        m1.intersect(getBoundsFuego());
        return !m1.isEmpty();
    }
      
      public boolean choqueInterruptorC(){
        Area m1 = new Area(p.ic.getBoundsInterruptorC());
        m1.intersect(getBoundsFuego());
        return !m1.isEmpty();
    }
      
      public boolean choqueBarra1(){
        Area m1 = new Area(p.barra1.getBoundsBarra1());
        m1.intersect(getBoundsFuego());
        return !m1.isEmpty();
    }
      public boolean choquePalanca(){
        Area m1 = new Area(p.palanca.getBoundsInterruptor());
        m1.intersect(getBoundsFuego());
        return !m1.isEmpty();
    }
    
     public boolean choqueBarra2(){
        Area m1 = new Area(p.barra2.getBoundsBarra2());
        m1.intersect(getBoundsFuego());
        return !m1.isEmpty();
    }
