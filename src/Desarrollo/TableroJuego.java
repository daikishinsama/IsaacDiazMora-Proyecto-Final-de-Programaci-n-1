...
public class TableroJuego extends JPanel{
    ...
    Agua a = new Agua();
    Lava l = new Lava();
    Barra1 barra1=new Barra1();
    Interruptor interruptor=new Interruptor();
    Barra2 barra2=new Barra2();
    Palanca palanca=new Palanca();
    Compuerta compuerta = new Compuerta();
    InterruptorCompuerta ic = new InterruptorCompuerta();
    ...
    public void paint(Graphics grafico){
        ...
        if(obtieneNivel()==1){
            barra1.paint(grafico);
            interruptor.paint(grafico);
            barra1.mover();
            barra2.paint(grafico);
            barra2.mover();
            palanca.paint(grafico);
        }
        if(obtieneNivel()==2){
            compuerta.paint(grafico);
            ic.paint(grafico);
            compuerta.mover();
        }
        niñofuego.mover();
