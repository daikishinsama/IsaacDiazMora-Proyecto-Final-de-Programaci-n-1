...
public class DiamanteAzul {
    private static int x1=40,x2=520,x3=680,x4=1120,x5=1280,x6=600,x7=40,x8=440,x9=880,x10=520;
    private static int y1=560,y2=480,y3=80,y4=520,y5=320,y6=360,y7=200,y8=160,y9=200,y10=640;
    ...
    private static int alto=40;
     ...
     public void paint(Graphics grafico){
        ...
        if(TableroJuego.obtieneNivel()==1){
            ...
            if(mo1==false){
                ImageIcon m1 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo2==false){
                ImageIcon m2 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo3==false){
                ImageIcon m3 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo4==false){
                ImageIcon m4 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo5==false){
                ImageIcon m5 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo6==false){
                ImageIcon m6 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo7==false){
                ImageIcon m7 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo8==false){
                ImageIcon m8 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo9==false){
                ImageIcon m9 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
            ...
            if(mo10==false){
                ImageIcon m10 = new ImageIcon(getClass().getResource("../images/mapas/diamond_blue.png"));
