...
public class Lava {
    private static int x1=1040,x2=1080,x3=720,x4=1080,x5=1160,x6=0,x7=120,x8=440,x9=800,x10=180;
    private static int y1=640,y2=640,y3=120,y4=400,y5=360,y6=0,y7=240,y8=320,y9=680,y10=600;
    ...
    public void paint(Graphics g){
        ...
        g.drawImage(m6.getImage(),x6,y6,0,0,null);
