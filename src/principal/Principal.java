...
import Desarrollo.Compuerta;
import Desarrollo.LevelsResumen;
import Desarrollo.NinaAgua;
import Desarrollo.NinoFuego;
            ...
            while(true){
                 ...
                 if(resumen==true){
                  ...
                  if(ganarjuego==true){
                    ...
                    NinaAgua.interruptor=false;
                    NinaAgua.interruptorC=false;
                    NinaAgua.palanca=false;
                    NinoFuego.interruptor=false;
                    NinoFuego.interruptorC=false;
                    NinoFuego.palanca=false;
                    Compuerta.x=1040;
                    Compuerta.y=560;
                 }
                  if(gameover==true){
